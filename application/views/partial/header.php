  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="index.html" class="navbar-brand sidebar-gone-hide">Gizi</a>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="d-sm-none d-lg-inline-block">Hi, Bagas Arbiansyah</div></a>
        ...
        <div class="container">
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              <a href="<?php echo site_url('dokter') ; ?>" class="nav-link has-dropdown"><i class="fas fa-fire"></i><span>Dokter</span></a>

            </li>
            <li class="nav-item ">
              <a href="<?php echo site_url('makanan') ; ?>"  class="nav-link"><i class="far fa-clone"></i><span>Makanan</span></a>
            </li>
            <li class="nav-item ">
              <a href="<?php echo site_url('pegawai') ; ?>" class="nav-link"><i class="far fa-heart"></i><span>Pegawai</span></a>
            </li>
          </ul>
        </div>
      </nav>
