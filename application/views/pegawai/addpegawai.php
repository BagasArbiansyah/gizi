<?php echo form_open('pegawai/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="kd_pegawai" value="<?php echo $this->input->post('kd_pegawai'); ?>" class="form-control" id="kd_pegawai" />
		</div>
	</div>
	<div class="form-group">
		<label for="nm_pegawai" class="col-md-4 control-label">Nm Pegawai</label>
		<div class="col-md-8">
			<input type="text" name="nm_pegawai" value="<?php echo $this->input->post('nm_pegawai'); ?>" class="form-control" id="nm_pegawai" />
		</div>
	</div>
